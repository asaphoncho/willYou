...
function Intro({fadeOut, currentMessage, messages, icons, isRunning, changeMessage, buttonActive, startTrials}){
    ...
    return(
        <>
            <div className='mainscreenDiv'>
                ...
                {currentMessage > 0 && currentMessage < messages.length ? <span>hi</span>: null}
